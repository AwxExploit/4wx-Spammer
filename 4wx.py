...
def logo():
  print """%s
    ___
   / __|_ __  __ _ _ __  _ __  ___ _ _ ___ %sAuthor by %sRiky Drmwn%s
   \__ \ '_ \/ _` | '  \| '  \/ -_) '_(_-< %sGithub %sgithub.com/RikyDrmwn%s
   |___/ .__/\__,_|_|_|_|_|_|_\___|_| /__/ %sTeam %sTHE UNKNOW DARKNET%s
       |_|                                 %sTools spam otp dengan 30 spammers"""%(qu,pu,ku,qu,pu,ku,qu,pu,ku,qu,qu)
#-------------------------------Input Function------------------------------------------
def input():
  global nom
  nom = raw_input("%s[%s?%s] %sMasukkan nomor target contoh (857xxx) : "%(pu,me,pu,pu))
  if len(nom) < 5:
